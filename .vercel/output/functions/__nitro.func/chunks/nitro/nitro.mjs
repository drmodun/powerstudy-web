...
const require$$0$1 = /*@__PURE__*/getDefaultExportFromNamespaceIfNotNamed(v$1);
...
const appConfig$1 = {"name":"vinxi","routers":[{"name":"public","type":"static","dir":"./public","base":"/","root":"/media/drmodun/data/repos/powerstudy-web","order":0,"outDir":"/media/drmodun/data/repos/powerstudy-web/.vinxi/build/public"},{"name":"client","type":"client","target":"browser","handler":"app/client.tsx","base":"/_build","build":{"sourcemap":true},"root":"/media/drmodun/data/repos/powerstudy-web","outDir":"/media/drmodun/data/repos/powerstudy-web/.vinxi/build/client","order":1},{"name":"ssr","type":"http","target":"server","handler":"app/ssr.tsx","link":{"client":"client"},"root":"/media/drmodun/data/repos/powerstudy-web","base":"/","outDir":"/media/drmodun/data/repos/powerstudy-web/.vinxi/build/ssr","order":2},{"name":"server","type":"http","target":"server","base":"/_server","handler":"node_modules/@tanstack/start/dist/esm/server-handler/index.js","root":"/media/drmodun/data/repos/powerstudy-web","outDir":"/media/drmodun/data/repos/powerstudy-web/.vinxi/build/server","order":3}],"server":{"preset":"vercel","experimental":{"asyncContext":true}},"root":"/media/drmodun/data/repos/powerstudy-web"};
				const buildManifest = {"client":{"/media/drmodun/data/repos/powerstudy-web/app/styles/globals.css":{"file":"assets/globals-kFB1rRJQ.css","src":"/media/drmodun/data/repos/powerstudy-web/app/styles/globals.css"},"_client-Bo7-ra-w.js":{"file":"assets/client-Bo7-ra-w.js","name":"client","dynamicImports":["app/routes/index.tsx?tsr-split","app/routes/index.tsx?tsr-split"],"assets":["assets/globals-kFB1rRJQ.css"]},"app/routes/index.tsx?tsr-split":{"file":"assets/index-j-bK4OYZ.js","name":"index","src":"app/routes/index.tsx?tsr-split","isDynamicEntry":true,"imports":["_client-Bo7-ra-w.js"]},"virtual:$vinxi/handler/client":{"file":"assets/client-zYCS2OiM.js","name":"client","src":"virtual:$vinxi/handler/client","isEntry":true,"imports":["_client-Bo7-ra-w.js"]}},"ssr":{"/media/drmodun/data/repos/powerstudy-web/app/styles/globals.css":{"file":"assets/globals-kFB1rRJQ.css","src":"/media/drmodun/data/repos/powerstudy-web/app/styles/globals.css"},"_ssr-y_ue5_Rc.js":{"file":"assets/ssr-y_ue5_Rc.js","name":"ssr","dynamicImports":["app/routes/index.tsx?tsr-split","app/routes/index.tsx?tsr-split"],"assets":["assets/globals-kFB1rRJQ.css"]},"app/routes/index.tsx?tsr-split":{"file":"assets/index-CCgIp-uY.js","name":"index","src":"app/routes/index.tsx?tsr-split","isDynamicEntry":true,"imports":["_ssr-y_ue5_Rc.js"]},"virtual:$vinxi/handler/ssr":{"file":"ssr.js","name":"ssr","src":"virtual:$vinxi/handler/ssr","isEntry":true,"imports":["_ssr-y_ue5_Rc.js"]}},"server":{"app/routes/index.tsx?tsr-split":{"file":"c_1h7ajdd.mjs","name":"c_1h7ajdd","src":"app/routes/index.tsx?tsr-split","isEntry":true},"virtual:$vinxi/handler/server":{"file":"entry.mjs","name":"entry","src":"virtual:$vinxi/handler/server","isEntry":true}}};
...
function h(e,t,n){return Object.assign(e,{url:"https://localhost:3000"})}function N(e){return e instanceof Headers?new Headers(e):Array.isArray(e)?new Headers(e):typeof e=="object"?new Headers(e):new Headers}function B$1(...e){return e.reduce((t,n)=>{const r=N(n);for(const[o,a]of r.entries())t.set(o,a);return t},new Headers)}function u(e,t){const n=t||e||{};return typeof n.method>"u"&&(n.method="GET"),{options:n,middleware:r=>u(void 0,Object.assign(n,{middleware:r})),validator:r=>u(void 0,Object.assign(n,{validator:r})),handler:(...r)=>{const[o,a]=r;Object.assign(n,{...o,extractedFn:o,serverFn:a}),w$3(o.url,"createServerFn must be called with a function that is marked with the 'use server' pragma. Are you using the @tanstack/start-vite-plugin ?");const s=[...n.middleware||[],R$2(n)];return Object.assign(async i=>f(s,"client",{...o,method:n.method,data:i?.data,headers:i?.headers,context:Object.assign({},o)}).then(d=>d.result),{...o,__executeServer:i=>{const d=i instanceof FormData?V(i):i;return f(s,"server",{...o,...d}).then(c=>({result:c.result,context:c.sendContext}))}})}}}function V(e){const t=e.get("__TSR_CONTEXT");if(e.delete("__TSR_CONTEXT"),typeof t!="string")return {context:{},data:e};try{return {context:defaultTransformer.parse(t),data:e}}catch{return {data:e}}}function G$1(e){const t=[],n=r=>{r.forEach(o=>{o.options.middleware&&n(o.options.middleware),t.push(o);});};return n(e),t}const l$1=(e,t,n)=>e({data:t.data,context:t.context,sendContext:t.sendContext,method:t.method,next:r=>{const o={...t.context,...r?.context},a={...t.sendContext,...r?.sendContext??{}},s=B$1(t.headers,r?.headers);return n({method:t.method,data:t.data,context:o,sendContext:a,headers:s,result:r?.result??t.result})}});function L$2(e,t){if(e==null)return {};if("~standard"in e){const n=e["~standard"].validate(t);if(n instanceof Promise)throw new Error("Async validation not supported");if(n.issues)throw new Error(JSON.stringify(n.issues,void 0,2));return n.value}if("parse"in e)return e.parse(t);if(typeof e=="function")return e(t);throw new Error("Invalid validator type!")}async function f(e,t,n){const r=G$1(e),o=async a=>{const s=r.shift();if(!s)return a;s.options.validator&&(t!=="client"||s.options.validateClient)&&(a.data=await L$2(s.options.validator,a.data));const i=t==="client"?s.options.client:s.options.server;return i?l$1(i,a,async d=>{if(t==="client"&&s.options.clientAfter){const c=await o(d);return l$1(s.options.clientAfter,c,O=>O)}return o(d)}):o(a)};return o({...n,headers:n.headers||{},sendContext:n.sendContext||{},context:n.context||{}})}function R$2(e){return {_types:void 0,options:{validator:e.validator,validateClient:e.validateClient,client:async({next:t,sendContext:n,...r})=>{var o;const a=await((o=e.extractedFn)==null?void 0:o.call(e,{...r,context:n}));return t(a)},server:async({next:t,...n})=>{var r;const o=await((r=e.serverFn)==null?void 0:r.call(e,n));return t({result:o})}}}}function U$1(...e){return twMerge(clsx(e))}const X=cva("inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",{variants:{variant:{default:"bg-primary text-primary-foreground shadow hover:bg-primary/90",destructive:"bg-destructive text-destructive-foreground shadow-sm hover:bg-destructive/90",outline:"border border-input bg-background shadow-sm hover:bg-accent hover:text-accent-foreground",secondary:"bg-secondary text-secondary-foreground shadow-sm hover:bg-secondary/80",ghost:"hover:bg-accent hover:text-accent-foreground",link:"text-primary underline-offset-4 hover:underline"},size:{default:"h-9 px-4 py-2",sm:"h-8 rounded-md px-3 text-xs",lg:"h-10 rounded-md px-8",icon:"h-9 w-9"}},defaultVariants:{variant:"default",size:"default"}}),m=y$1.forwardRef(({className:e,variant:t,size:n,asChild:r=!1,...o},a)=>jsx(r?Slot:"button",{className:U$1(X({variant:t,size:n,className:e})),ref:a,...o}));m.displayName="Button";const J$1=()=>Promise.resolve().then(()=>F$1),q=()=>Promise.resolve().then(()=>F$1),p=createFileRoute("/")({component:lazyRouteComponent(q,"component",()=>p.ssr),loader:lazyFn(J$1,"loader")}),w$2="count.txt";async function g(){return parseInt(await v$1.promises.readFile(w$2,"utf-8").catch(()=>"0"))}const x=u({method:"GET"}).handler(h(b),()=>g()),y=u({method:"POST"}).validator(e=>e).handler(h(_),async({data:e})=>{const t=await g();await v$1.promises.writeFile(w$2,`${t+e}`);}),K=function(){const t=useRouter(),n=p.useLoaderData();return jsxs(m,{variant:"outline",onClick:()=>{y({data:1}).then(()=>{t.invalidate();});},children:["Add 1 to ",n,"?"]})},Q=async()=>await x();function b(e){return x.__executeServer(e)}function _(e){return y.__executeServer(e)}const F$1=Object.freeze(Object.defineProperty({__proto__:null,$$function0:b,$$function1:_,component:K,loader:Q},Symbol.toStringTag,{value:"Module"}));
...
function de(e) {
  ...
  if (s !== void 0 || o !== void 0 || (n == null ? void 0 : n.length)) {
    ...
    return jsxs(Fragment, { children: [jsx(ScriptOnce, { children: a }), n ? n.map((i) => i.type === "stream" ? jsx(pe, { entry: i }, i.id) : jsx(fe, { entry: i }, i.id)) : null] });
  }
  return null;
}
function w(e, r, t = []) {
...
function pe({ entry: e }) {
  w$3(e.streamState, "StreamState should be defined");
  const r = useRouter();
  return jsx($, { streamState: e.streamState, children: (t) => {
...
function $({ streamState: e, children: r, __index: t = 0 }) {
  const n = e.promises[t];
  if (!n) return null;
  if (n.status === "pending") throw n;
  const s = n.value;
  return jsxs(Fragment, { children: [r(s), jsx("div", { className: "tsr-once", children: jsx(y$1.Suspense, { fallback: null, children: jsx($, { streamState: e, __index: t + 1, children: r }) }) })] });
}
function H(e, r, t) {
...
function R(e) {
  return function(...r) {
    var _a;
    let t = r[0];
    if (ge(t)) r[0] = t instanceof H3Event || t.__is_event__ ? t : t[I];
    else {
...
const Me = /(<body)/, qe = /(<\/body>)/, ke = /(<\/html>)/, Pe = /(<\/[a-zA-Z][\w:.-]*?>)/g, $e = new TextDecoder();
function L(e) {
  let r = false, t = "", n = "";
  return { async transform(s, o) {
    const a = t + $e.decode(s), i = a.match(Me), c = a.match(qe), l = a.match(ke);
    try {
      if (i && (r = true), !r) {
        o(a), t = "";
        return;
      ...
      if (c && l && c.index < l.index) {
        ...
        let f, p = 0;
        for (; (f = Pe.exec(a)) !== null; ) p = f.index + f[0].length;
        if (p > 0) {
...
const Ie = async ({ request: e, router: r, responseHeaders: t }) => {
  if (typeof x$2.renderToReadableStream == "function") {
    const n = await x$2.renderToReadableStream(jsx(E, { router: r }), { signal: e.signal });
    isbot(e.headers.get("User-Agent")) && await n.allReady;
    const o = [Ee(r)].reduce((a, i) => a.pipeThrough(i), n);
    return new Response(o, { status: r.state.statusCode, headers: t });
  }
  if (typeof x$2.renderToPipeableStream == "function") {
    const n = new PassThrough(), s = x$2.renderToPipeableStream(jsx(E, { router: r }), { ...isbot(e.headers.get("User-Agent")) ? { onAllReady() {
      s.pipe(n);
    } } : { onShellReady() {
      s.pipe(n);
    } }, onError: (i, c) => {
...
}, Ae = () => ({ routes: { __root__: { filePath: "__root.tsx", children: ["/"], preloads: ["/_build/assets/client-zYCS2OiM.js", "/_build/assets/client-Bo7-ra-w.js"] }, "/": { filePath: "index.tsx" } } });
function Le(e) {
...
const We = "/_build/assets/globals-kFB1rRJQ.css";
...
const Oe = () => {
  ...
  const e = useRouter(), r = Oe(), t = y$1.useContext(Context.get("TanStackRouterHydrationContext", {}));
...
}, D = createRootRoute({ head: () => ({ meta: [{ charSet: "utf-8" }, { name: "viewport", content: "width=device-width, initial-scale=1" }, { title: "TanStack Start Starter" }], links: [{ rel: "stylesheet", href: We }] }), component: Ue });
function Ue() {
  return jsx(Qe, { children: jsx(Outlet, {}) });
}
function Qe({ children: e }) {
  return jsxs("html", { children: [jsx("head", { children: jsx(Fe, {}) }), jsxs("body", { children: [e, jsx(ScrollRestoration, {}), jsx(Ne, {})] })] });
}
const Je = () => import('../build/index-CCgIp-uY.mjs'), Ve = () => import('../build/index-CCgIp-uY.mjs'), W = createFileRoute("/")({ component: lazyRouteComponent(Ve, "component", () => W.ssr), loader: lazyFn(Je, "loader") }), Ge = W.update({ id: "/", path: "/", getParentRoute: () => D }), Ye = { IndexRoute: Ge }, Ze = D._addFileChildren(Ye)._addFileTypes();
function Ke() {
...
export { Le as L, M, Se as S, Te as T, W, dt as d, eventHandler as e, ft as f, listener as l, node$1 as n };
