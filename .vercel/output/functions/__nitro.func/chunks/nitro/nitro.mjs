...
const appConfig$1 = {"name":"vinxi","routers":[{"name":"public","type":"static","dir":"./public","base":"/","root":"/media/drmodun/data/repos/powerstudy-web","order":0,"outDir":"/media/drmodun/data/repos/powerstudy-web/.vinxi/build/public"},{"name":"client","type":"client","target":"browser","handler":"app/client.tsx","base":"/_build","build":{"sourcemap":true},"root":"/media/drmodun/data/repos/powerstudy-web","outDir":"/media/drmodun/data/repos/powerstudy-web/.vinxi/build/client","order":1},{"name":"ssr","type":"http","target":"server","handler":"app/ssr.tsx","link":{"client":"client"},"root":"/media/drmodun/data/repos/powerstudy-web","base":"/","outDir":"/media/drmodun/data/repos/powerstudy-web/.vinxi/build/ssr","order":2},{"name":"server","type":"http","target":"server","base":"/_server","handler":"node_modules/@tanstack/start/dist/esm/server-handler/index.js","root":"/media/drmodun/data/repos/powerstudy-web","outDir":"/media/drmodun/data/repos/powerstudy-web/.vinxi/build/server","order":3}],"server":{"preset":"vercel","experimental":{"asyncContext":true}},"root":"/media/drmodun/data/repos/powerstudy-web"};
				const buildManifest = {"client":{"/media/drmodun/data/repos/powerstudy-web/app/styles/globals.css":{"file":"assets/globals-nX35q7hc.css","src":"/media/drmodun/data/repos/powerstudy-web/app/styles/globals.css"},"_button-bHgVaFZX.js":{"file":"assets/button-bHgVaFZX.js","name":"button","imports":["_client-nJBCY_2R.js","_link-CbgnX7Y5.js"]},"_client-nJBCY_2R.js":{"file":"assets/client-nJBCY_2R.js","name":"client","dynamicImports":["app/routes/signup.tsx?tsr-split","app/routes/login.tsx?tsr-split","app/routes/index.tsx?tsr-split"],"assets":["assets/globals-nX35q7hc.css"]},"_link-CbgnX7Y5.js":{"file":"assets/link-CbgnX7Y5.js","name":"link","imports":["_client-nJBCY_2R.js"]},"app/routes/index.tsx?tsr-split":{"file":"assets/index-DBxhr99s.js","name":"index","src":"app/routes/index.tsx?tsr-split","isDynamicEntry":true,"imports":["_client-nJBCY_2R.js","_link-CbgnX7Y5.js"]},"app/routes/login.tsx?tsr-split":{"file":"assets/login-C25WIkx-.js","name":"login","src":"app/routes/login.tsx?tsr-split","isDynamicEntry":true,"imports":["_client-nJBCY_2R.js","_button-bHgVaFZX.js","_link-CbgnX7Y5.js"]},"app/routes/signup.tsx?tsr-split":{"file":"assets/signup-BhrnYl8P.js","name":"signup","src":"app/routes/signup.tsx?tsr-split","isDynamicEntry":true,"imports":["_client-nJBCY_2R.js","_button-bHgVaFZX.js","_link-CbgnX7Y5.js"]},"virtual:$vinxi/handler/client":{"file":"assets/client-1eHig3uM.js","name":"client","src":"virtual:$vinxi/handler/client","isEntry":true,"imports":["_client-nJBCY_2R.js"]}},"ssr":{"/media/drmodun/data/repos/powerstudy-web/app/styles/globals.css":{"file":"assets/globals-nX35q7hc.css","src":"/media/drmodun/data/repos/powerstudy-web/app/styles/globals.css"},"_button-lwJa8Kew.js":{"file":"assets/button-lwJa8Kew.js","name":"button"},"app/routes/index.tsx?tsr-split":{"file":"assets/index-BykuP3eG.js","name":"index","src":"app/routes/index.tsx?tsr-split","isDynamicEntry":true},"app/routes/login.tsx?tsr-split":{"file":"assets/login-DWu83dvC.js","name":"login","src":"app/routes/login.tsx?tsr-split","isDynamicEntry":true,"imports":["_button-lwJa8Kew.js"]},"app/routes/signup.tsx?tsr-split":{"file":"assets/signup-SDwtgktg.js","name":"signup","src":"app/routes/signup.tsx?tsr-split","isDynamicEntry":true,"imports":["_button-lwJa8Kew.js"]},"virtual:$vinxi/handler/ssr":{"file":"ssr.js","name":"ssr","src":"virtual:$vinxi/handler/ssr","isEntry":true,"dynamicImports":["app/routes/signup.tsx?tsr-split","app/routes/login.tsx?tsr-split","app/routes/index.tsx?tsr-split"],"assets":["assets/globals-nX35q7hc.css"]}},"server":{"virtual:$vinxi/handler/server":{"file":"entry.mjs","name":"entry","src":"virtual:$vinxi/handler/server","isEntry":true}}};
...
function de(e) {
  ...
  const n = t.extracted, [o, s] = ["__beforeLoadContext", "loaderData"].map((a) => n ? n.reduce((i, c) => c.dataType !== a ? H(i, ["temp", ...c.path], void 0) : i, { temp: t[a] }).temp : t[a]);
  if (o !== void 0 || s !== void 0 || (n == null ? void 0 : n.length)) {
    const a = `__TSR__.initMatch(${y({ index: e.matchIndex, __beforeLoadContext: r.options.transformer.stringify(o), loaderData: r.options.transformer.stringify(s), extracted: n ? Object.fromEntries(n.map((i) => [i.id, pick(i, ["type", "path"])])) : {} }, { isScriptContext: true, wrap: true, json: true })})`;
...
function me({ entry: e }) {
  return jsx("div", { className: "tsr-once", children: jsx(s$2.Suspense, { fallback: null, children: jsx(fe, { entry: e }) }) });
}
function fe({ entry: e }) {
  const r = useRouter();
  if (e.value.status === "pending") throw e.value;
  const t = `__TSR__.resolvePromise(${y(e, { isScriptContext: true, wrap: true, json: true })})`;
  return r.injectScript(t), jsx(Fragment, {});
}
function pe({ entry: e }) {
  g(e.streamState, "StreamState should be defined");
  const r = useRouter();
  return jsx(L, { streamState: e.streamState, children: (t) => {
    const n = t ? `__TSR__.matches[${e.matchIndex}].extracted[${e.id}].value.controller.enqueue(new TextEncoder().encode(${y(t.toString(), { isScriptContext: true, wrap: true, json: true })}))` : `__TSR__.matches[${e.matchIndex}].extracted[${e.id}].value.controller.close()`;
...
function L({ streamState: e, children: r, __index: t = 0 }) {
  const n = e.promises[t];
  if (!n) return null;
  if (n.status === "pending") throw n;
  const o = n.value;
  return jsxs(Fragment, { children: [r(o), jsx("div", { className: "tsr-once", children: jsx(s$2.Suspense, { fallback: null, children: jsx(L, { streamState: e, __index: t + 1, children: r }) }) })] });
}
function H(e, r, t) {
...
function $(e) {
  e.router.AfterEachMatch = de, e.router.serializer = (n) => y(n, { isScriptContext: true, wrap: true, json: true });
  const r = Context.get("TanStackRouterHydrationContext", {}), t = s$2.useMemo(() => {
    var n, o;
...
function ge(e) {
  var _a;
  return (_a = e.web) != null ? _a : e.web = { request: _e(e), url: B(e) }, e.web.request;
}
function Se() {
  return Te();
}
...
function M(e) {
  return function(...r) {
    var _a;
    let t = r[0];
    if (ye(t)) r[0] = t instanceof H3Event || t.__is_event__ ? t : t[D];
    else {
...
const B = M(getRequestURL), Re = M(getResponseHeaders), xe = M(getRequestWebStream);
function ve() {
  var _a;
...
function we({ createRouter: e, getRouterManifest: r }) {
  return (t) => eventHandler(async (n) => {
    const o = ge(n), s = new URL(o.url), a = s.href.replace(s.origin, ""), i = createMemoryHistory({ initialEntries: [a] }), c = e();
...
function He(e) {
  ...
  let r = k(Re(e.event), { "Content-Type": "text/html; charset=UTF-8" }, ...e.router.state.matches.map((n) => n.headers));
  const { redirect: t } = e.router.state;
  return t && (r = k(r, t.headers, { Location: t.href })), r;
}
function Ce(e) {
  const r = W(() => e.injectedHtml.map((t) => t()).join(""));
...
function Ee(e) {
  const r = W(() => e.injectedHtml.map((n) => n()).join("")), t = new TextEncoder();
...
const Me = /(<body)/, Pe = /(<\/body>)/, $e = /(<\/html>)/, ke = /(<\/[a-zA-Z][\w:.-]*?>)/g, qe = new TextDecoder();
function W(e) {
  let r = false, t = "", n = "";
  return { async transform(o, s) {
    const a = t + qe.decode(o), i = a.match(Me), c = a.match(Pe), l = a.match($e);
    try {
      if (i && (r = true), !r) {
        s(a), t = "";
        return;
      ...
      if (c && l && c.index < l.index) {
        const m = c.index + c[0].length, p = l.index + l[0].length, v = a.slice(0, m) + d + a.slice(m, p) + a.slice(p);
        s(v), t = "";
      } else {
        let m, p = 0;
        for (; (m = ke.exec(a)) !== null; ) p = m.index + m[0].length;
        if (p > 0) {
...
const Ie = async ({ request: e, router: r, responseHeaders: t }) => {
  if (typeof R$1.renderToReadableStream == "function") {
    const n = await R$1.renderToReadableStream(jsx($, { router: r }), { signal: e.signal });
    isbot(e.headers.get("User-Agent")) && await n.allReady;
    const s = [Ee(r)].reduce((a, i) => a.pipeThrough(i), n);
    return new Response(s, { status: r.state.statusCode, headers: t });
  }
  if (typeof R$1.renderToPipeableStream == "function") {
    const n = new PassThrough(), o = R$1.renderToPipeableStream(jsx($, { router: r }), { ...isbot(e.headers.get("User-Agent")) ? { onAllReady() {
      o.pipe(n);
    } } : { onShellReady() {
      o.pipe(n);
    } }, onError: (i, c) => {
      console.log("Error in renderToPipeableStream:", i, c);
    } }), a = [Ce(r)].reduce((i, c) => i.pipe(c), n);
    return new Response(a, { status: r.state.statusCode, headers: t });
  }
  throw new Error("No renderToReadableStream or renderToPipeableStream found in react-dom/server. Ensure you are using a version of react-dom that supports streaming.");
}, Ae = () => ({ routes: { __root__: { filePath: "__root.tsx", children: ["/", "/login", "/signup"], preloads: ["/_build/assets/client-1eHig3uM.js", "/_build/assets/client-nJBCY_2R.js"] }, "/": { filePath: "index.tsx" }, "/login": { filePath: "login.tsx" }, "/signup": { filePath: "signup.tsx" } } });
function Le(e) {
...
const We = "/_build/assets/globals-nX35q7hc.css";
function O({ tag: e, attrs: r, children: t }) {
  switch (e) {
    case "title":
...
const Oe = () => {
  const e = useRouter(), r = useRouterState({ select: (s) => s.matches.map((a) => a.meta).filter(Boolean) }), t = s$2.useMemo(() => {
    const s = [], a = {};
    let i;
  ...
  return Fe([...t, ...o, ...n], (s) => JSON.stringify(s));
}, je = () => {
  const e = useRouter(), r = Oe(), t = s$2.useContext(Context.get("TanStackRouterHydrationContext", {}));
  return jsxs(Fragment, { children: [r.map((n, o) => createElement(O, { ...n, key: `tsr-meta-${JSON.stringify(n)}` })), jsxs(Fragment, { children: [jsx(ScriptOnce, { log: false, children: '__TSR__={matches:[],streamedValues:{},queue:[],runQueue:()=>{let e=!1;__TSR__.queue=__TSR__.queue.filter((_=>!_()||(e=!0,!1))),e&&__TSR__.runQueue()},initMatch:e=>{__TSR__.queue.push((()=>(__TSR__.matches[e.index]||(__TSR__.matches[e.index]=e,Object.entries(e.extracted).forEach((([e,_])=>{if("stream"===_.type){let e;_.value=new ReadableStream({start(_){e=_}}),_.value.controller=e}else if("promise"===_.type){let e,t;_.value=new Promise(((_,u)=>{e=_,t=u})),_.resolve=e,_.reject=t}}))),!0))),__TSR__.runQueue()},resolvePromise:e=>{__TSR__.queue.push((()=>{const _=__TSR__.matches[e.matchIndex];if(_){const t=_.extracted[e.id];if(t)return t.resolve(e.value.data),!0}return!1})),__TSR__.runQueue()},cleanScripts:()=>{document.querySelectorAll(".tsr-once").forEach((e=>{e.remove()}))}};' }), jsx(ScriptOnce, { children: `__TSR__.dehydrated = ${y(e.options.transformer.stringify(t), { isScriptContext: true, wrap: true, json: true })}` })] })] });
}, Ne = () => jsx(Fragment, { children: je() });
function Fe(e, r) {
...
const Ue = () => {
  ...
  return jsx(Fragment, { children: n.map((o, s) => createElement(O, { ...o, key: `tsr-scripts-${o.tag}-${s}` })) });
}, x = createRootRoute({ head: () => ({ meta: [{ charSet: "utf-8" }, { name: "viewport", content: "width=device-width, initial-scale=1" }, { title: "TanStack Start Starter" }], links: [{ rel: "stylesheet", href: We }] }), component: ze });
function ze() {
  return jsxs(Qe, { children: [jsx(Outlet, {}), jsx(TanStackRouterDevtools, {})] });
}
function Qe({ children: e }) {
  return jsxs("html", { children: [jsx("head", { children: jsx(Ne, {}) }), jsxs("body", { children: [e, jsx(ScrollRestoration, {}), jsx(Ue, {})] })] });
}
const Je = () => import('../build/signup-SDwtgktg.mjs'), j = createFileRoute("/signup")({ component: lazyRouteComponent(Je, "component", () => j.ssr) }), Ve = () => import('../build/login-DWu83dvC.mjs'), N = createFileRoute("/login")({ component: lazyRouteComponent(Ve, "component", () => N.ssr) }), Ge = () => import('../build/index-BykuP3eG.mjs'), F = createFileRoute("/")({ component: lazyRouteComponent(Ge, "component", () => F.ssr) }), Xe = j.update({ id: "/signup", path: "/signup", getParentRoute: () => x }), Ye = N.update({ id: "/login", path: "/login", getParentRoute: () => x }), Ze = F.update({ id: "/", path: "/", getParentRoute: () => x }), Ke = { IndexRoute: Ze, LoginRoute: Ye, SignupRoute: Xe }, et = x._addFileChildren(Ke)._addFileTypes();
function tt() {
  return createRouter$2({ routeTree: et });
}
const ht = we({ createRouter: tt, getRouterManifest: Be })(Ie);
...
storage.mount('data', unstorage_47drivers_47fs_45lite({"driver":"fsLite","base":"/media/drmodun/data/repos/powerstudy-web/.data/kv"}));
...
export { listener as l, node$1 as n };
